const dictionary = [
  {"word": "Game","hint": "Play when you're bored",},
  {"word": "Pain","hint": "Attending any class other than ENSF 381 gives you ____",},
  {"word": "Nerd","hint": "You may be considered one if you like Star Trek",},
  {"word": "Main","hint": "Name of the function that starts a program in Golang and Java",},
  ...
  {"word": "Borg","hint": "An alien group in the Star Trek Universe",},
...
async function wordGenerator() {
  ...
  // Replacing the API call with local dictionary
  const generateRandomIndex = Math.floor(Math.random() * dictionary.length);
